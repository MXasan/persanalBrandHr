...
const services = [
  {
    ...
    ctaBorder: "border-[#FFD060]",
    ctaTextColor: "text-[#D4A017]",
    ctaBg: "hover:bg-[#FFD060]/10",
    highlight: false,
  },
  {
  ...
  },
  {
    ...
    cta: "Book a talk",
    ctaBorder: "border-[#3B82F6]",
    ctaTextColor: "text-[#3B82F6]",
    ctaBg: "hover:bg-[#3B82F6]/10",
    highlight: false,
  },
  {
    icon: <Heart size={22} />,
    ...
    ctaBorder: "border-[#4ADE80]",
    ctaTextColor: "text-[#16a34a]",
    ctaBg: "hover:bg-[#4ADE80]/10",
    highlight: false,
  },
];
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-14">
          <motion.h2
            ...
            className="text-[#1C1C1E] max-w-lg font-extrabold text-[clamp(1.75rem,3vw,2.5rem)] leading-[1.2] tracking-[-0.02em]"
          >
            How I can help you
            <br />
          ...
          <motion.p
            ...
            className="text-[#9CA3AF] max-w-xs font-normal text-[0.9375rem] leading-[1.65]"
          >
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {services.map((service, idx) => (
            ...
            >
              ...
              {/* Tag */}
              <span
                className={`inline-block px-2.5 py-1 rounded-lg text-[0.75rem] font-bold mb-5 self-start mt-2 ${service.tagBg} ${service.tagColor}`}
              >
                {service.tag}
              </span>
              ...
              {/* Icon */}
              <div
                className={`w-11 h-11 rounded-2xl flex items-center justify-center mb-5 ${service.iconBg} ${service.iconColor}`}
              >
                {service.icon}
              </div>
              ...
              {/* CTA button */}
              <button
                className={`flex items-center gap-2 group/btn px-4 py-2.5 rounded-xl border-2 transition-all duration-200 self-start font-bold text-[0.875rem] ${service.ctaBg} ${service.ctaBorder} ${service.ctaTextColor}`}
              >
                {service.cta}
